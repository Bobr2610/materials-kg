...
from kg_engine.utils.file_utils import FileInfo, FileUtils
...
def read_local_path_to_plain_text(
    ...
    *,
    ...
    if ext == ".pdf":
        try:
            from kg_engine.utils.asset_extractor import extract_assets
            from kg_engine.tools.pdf_utils import PDFUtils
