...
try:
    ...
    from kg_engine.agent.image_models import (  # type: ignore[no-redef]
        get_default_model,
        get_model_config,
    )
    from kg_engine.agent.image_providers import (  # type: ignore[no-redef]
        ImageGenerationResult,
        ImageRequest,
        get_provider,
    )
    from kg_engine.agent.image_providers.openrouter import (  # type: ignore[no-redef]
        OpenRouterProvider,
    )
    from kg_engine.agent.key_resolution import get_provider_api_key
    from kg_engine.agent.session_manager import get_current_session_id
