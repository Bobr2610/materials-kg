...
if TYPE_CHECKING:
    ...
    from kg_engine.agent.token_counter import TokenCount
...
from kg_engine.agent.logging_config import setup_openapi_debug_log  # noqa: E402
...
def _prepare_request(
    ...
    from kg_engine.agent.session_manager import set_current_session_id, set_session_config
