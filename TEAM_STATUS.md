...
|------|----------|--------|--------|-------|-----------|
| Архитектор / Product | Codex | MVP/Beta-контур «Фабрика гипотез»; Docker OCR build ожидает восстановления Debian mirror | ожидает проверки | feat/api-hypothesis-factory | 2026-07-02 |
